...
namespace Tyuiu.SychevAD.Sprint2.Task2.V14.Lib
{
    public class DataService : ISprint2Task2V14
    {
        public bool CheckDotInShadedArea(int x, int y)
        {
            ...
            if (x == 10 & y == 4) { return true; }
            if (x == 11 & y == 4) { return true; }
            if (x == 12 & y == 4) { return true; }
